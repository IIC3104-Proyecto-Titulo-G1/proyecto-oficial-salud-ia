-- Actualizar el trigger para notificar cuando un médico jefe resuelve un caso pendiente
...
BEGIN
  ...
  IF (NEW.estado IN ('aceptado', 'rechazado')) 
    ...
    INSERT INTO notificaciones (
      ...
      'caso_resuelto',
      CASE 
        WHEN OLD.estado = 'derivado' THEN 'Caso derivado resuelto'
        ELSE 'Caso pendiente resuelto'
      END,
